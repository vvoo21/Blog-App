...
RSpec.describe 'Post Index page', type: :feature do
  before(:example) do
    @user = User.create(name: 'Vanessa', photo: 'https://unsplash.com/es/fotos/BXCZi9smw78',
                        bio: 'A passionate full-stack developer', posts_counter: 1)
    @post = Post.create(title: 'Hello rails', text: 'My first post', comments_counter: 1, likes_counter: 1,
                        author: @user)
